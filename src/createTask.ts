...
import CreateTaskModule from './modules/app/create-task.module';
...
async function bootstrap() {
  const app = await NestFactory.create(CreateTaskModule);
  ...
  const port = configService.get<number>('SERVER_POR') || 3002;

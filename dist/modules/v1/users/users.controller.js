...
const notify_user_dto_1 = __importDefault(require("./dto/notify-user.dto"));
let UsersController = class UsersController {
    ...
    async notifyUser(notifyUserDto) {
...
__decorate([
    ...
    (0, common_1.Post)('notify-user'),
    (0, auth_decorator_1.default)(),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [notify_user_dto_1.default]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "notifyUser", null);

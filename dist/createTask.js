...
const create_task_module_1 = __importDefault(require("./modules/app/create-task.module"));
const validation_exceptions_1 = __importDefault(require("./exceptions/validation.exceptions"));
const filters_1 = require("./filters");
async function bootstrap() {
    const app = await core_1.NestFactory.create(create_task_module_1.default);
    ...
    const port = configService.get('SERVER_POR') || 3002;
